### [![Typing SVG](https://readme-typing-svg.demolab.com?font=Rubik+Glitch&size=30&pause=1000&color=FFFFFF&center=true&vCenter=true&random=false&width=435&lines=Luiz+Paulo+Lima;Full-Stack+Developer;IT+Support+Analyst+N1/N2;Learning+Cloud+%26+Linux)](https://git.io/typing-svg)

## 👨‍💻 Sobre Mim
* 🎓 Graduado em **Análise e Desenvolvimento de Sistemas**.
* 🛠️ Atuação como **Analista de Suporte Técnico N1/N2**, com foco em redes e infraestrutura.
* 🐧 Entusiasta de sistemas **Linux**, atualmente aprofundando conhecimentos em distribuições Debian-based.
* 🚀 Desenvolvedor Full-Stack focado em construir soluções eficientes e escaláveis.
...
### Cloud, Infra & Redes (Em constante aprendizado)
